...
Chart show coverage of corpora by pruned 2- to 6-grams, where different color
indicates n-grams with a different number of pruned words (`UNK` tokens).
The same as for 2-grams, charts also show for several number points where
n-grams were encountered a particular number of times.
...
obvious: for example, there are much more common 2-grams as common 6-grams.
A consequence of this property is less obvious, but is clearly visible on
...
covers 95% of the corpora, but for n-grams choosing a subset is not possible.
...
# <a name="Conclusions and next steps"></a>Conclusions and next steps
