...
```{r cover2grams.95, echo=FALSE, cache=TRUE, fig.align='center', fig.width=10}
  # Enrich 2-grams: add columns indicating whether the 1st or 2nd words are
  # an UNK token.
  all.2gram.95.freq$UNK_1 <- grepl("UNK \\S+", all.2gram.95.freq$Terms)
  all.2gram.95.freq$UNK_2 <- grepl("\\S+ UNK", all.2gram.95.freq$Terms)
  # Enrich 2-grams: add percentage
  all.2gram.95.freq$Freq.Pct <- all.2gram.95.freq$Freq / sum(all.2gram.95.freq$Freq)
  #
  all.2gram.95.freq$WRD_WRD.Freq.Cum.Pct <- cumsum(
    ifelse(all.2gram.95.freq$UNK_1 | all.2gram.95.freq$UNK_2,
           0,
           all.2gram.95.freq$Freq.Pct))
  all.2gram.95.freq$UNK_WRD.Freq.Cum.Pct <- cumsum(
    ifelse(all.2gram.95.freq$UNK_1 & !all.2gram.95.freq$UNK_2,
           all.2gram.95.freq$Freq.Pct,
           0))
  all.2gram.95.freq$WRD_UNK.Freq.Cum.Pct <- cumsum(
    ifelse(!all.2gram.95.freq$UNK_1 & all.2gram.95.freq$UNK_2,
           all.2gram.95.freq$Freq.Pct,
           0))
  all.2gram.95.freq$UNK_UNK.Freq.Cum.Pct <- cumsum(
    ifelse(all.2gram.95.freq$UNK_1 & all.2gram.95.freq$UNK_2,
           all.2gram.95.freq$Freq.Pct,
           0))
  ...
  all.2gram.95.freq.pct <- rbind(
    data.frame("Type" = rep("UNK UNK", length(all.2gram.95.freq.idx)),
               ...
               "Freq.Pct" = all.2gram.95.freq$UNK_UNK.Freq.Cum.Pct[all.2gram.95.freq.idx]),
    data.frame("Type" = rep("UNK Word", length(all.2gram.95.freq.idx)),
               "Count" = all.2gram.95.freq.idx,
               "Freq.Pct" = all.2gram.95.freq$UNK_WRD.Freq.Cum.Pct[all.2gram.95.freq.idx]),
    data.frame("Type" = rep("Word UNK", length(all.2gram.95.freq.idx)),
               "Count" = all.2gram.95.freq.idx,
               "Freq.Pct" = all.2gram.95.freq$WRD_UNK.Freq.Cum.Pct[all.2gram.95.freq.idx]),
    data.frame("Type" = rep("Word Word", length(all.2gram.95.freq.idx)),
               "Count" = all.2gram.95.freq.idx,
               "Freq.Pct" = all.2gram.95.freq$WRD_WRD.Freq.Cum.Pct[all.2gram.95.freq.idx])
  )
