...
```{r cover2grams.95, echo=FALSE, cache=TRUE, cache.lazy=FALSE, fig.align='center', fig.width=10}
all.2gram.95.freq.enriched <- all.2gram.95.freq

# Enrich 2-grams: add columns indicating whether the 1st or 2nd words are
# an UNK token.
all.2gram.95.freq.enriched$UNK_1 <- grepl("UNK \\S+", all.2gram.95.freq.enriched$Terms)
all.2gram.95.freq.enriched$UNK_2 <- grepl("\\S+ UNK", all.2gram.95.freq.enriched$Terms)
# Enrich 2-grams: add percentage
all.2gram.95.freq.enriched$Freq.Pct <- all.2gram.95.freq.enriched$Freq / sum(all.2gram.95.freq.enriched$Freq)
#
all.2gram.95.freq.enriched$WRD_WRD.Freq.Cum.Pct <- cumsum(
  ifelse(all.2gram.95.freq.enriched$UNK_1 | all.2gram.95.freq.enriched$UNK_2,
         0,
         all.2gram.95.freq.enriched$Freq.Pct))
all.2gram.95.freq.enriched$UNK_WRD.Freq.Cum.Pct <- cumsum(
  ifelse(all.2gram.95.freq.enriched$UNK_1 & !all.2gram.95.freq.enriched$UNK_2,
         all.2gram.95.freq.enriched$Freq.Pct,
         0))
all.2gram.95.freq.enriched$WRD_UNK.Freq.Cum.Pct <- cumsum(
  ifelse(!all.2gram.95.freq.enriched$UNK_1 & all.2gram.95.freq.enriched$UNK_2,
         all.2gram.95.freq.enriched$Freq.Pct,
         0))
all.2gram.95.freq.enriched$UNK_UNK.Freq.Cum.Pct <- cumsum(
  ifelse(all.2gram.95.freq.enriched$UNK_1 & all.2gram.95.freq.enriched$UNK_2,
         all.2gram.95.freq.enriched$Freq.Pct,
         0))

# Use log-scale for sub-sampling the X axis.
all.2gram.95.freq.idx <- unique(as.integer(exp((1:1000) * log(nrow(all.2gram.95.freq.enriched)) / 1000)))

all.2gram.95.freq.pct <- rbind(
  data.frame("Type" = rep("UNK UNK", length(all.2gram.95.freq.idx)),
             "Count" = all.2gram.95.freq.idx,
             "Freq.Pct" = all.2gram.95.freq.enriched$UNK_UNK.Freq.Cum.Pct[all.2gram.95.freq.idx]),
  data.frame("Type" = rep("UNK Word", length(all.2gram.95.freq.idx)),
             "Count" = all.2gram.95.freq.idx,
             "Freq.Pct" = all.2gram.95.freq.enriched$UNK_WRD.Freq.Cum.Pct[all.2gram.95.freq.idx]),
  data.frame("Type" = rep("Word UNK", length(all.2gram.95.freq.idx)),
             "Count" = all.2gram.95.freq.idx,
             "Freq.Pct" = all.2gram.95.freq.enriched$WRD_UNK.Freq.Cum.Pct[all.2gram.95.freq.idx]),
  data.frame("Type" = rep("Word Word", length(all.2gram.95.freq.idx)),
             "Count" = all.2gram.95.freq.idx,
             "Freq.Pct" = all.2gram.95.freq.enriched$WRD_WRD.Freq.Cum.Pct[all.2gram.95.freq.idx])
)

# Clean up memory
rm(all.2gram.95.freq.enriched)
gc(full = TRUE)
...
gp <- ggplot(all.2gram.95.freq.pct,
...
```{r cover3grams.95, echo=FALSE, cache=TRUE, cache.lazy=FALSE, fig.align='center', fig.width=10}
all.3gram.95.freq.enriched <- all.3gram.95.freq

# Enrich 3-grams: add columns indicating whether n-th word is an UNK token.
all.3gram.95.freq.enriched$UNK_1 <- grepl("UNK \\S+ \\S+", all.3gram.95.freq.enriched$Terms)
all.3gram.95.freq.enriched$UNK_2 <- grepl("\\S+ UNK \\S+", all.3gram.95.freq.enriched$Terms)
all.3gram.95.freq.enriched$UNK_3 <- grepl("\\S+ \\S+ UNK", all.3gram.95.freq.enriched$Terms)

# Enrich 3-grams: add a column with a count of UNK token.
all.3gram.95.freq.enriched$UNK_N <- all.3gram.95.freq.enriched$UNK_1 +
  all.3gram.95.freq.enriched$UNK_2 +
  all.3gram.95.freq.enriched$UNK_3

# Enrich 3-grams: add percentage
all.3gram.95.freq.enriched$Freq.Pct <- all.3gram.95.freq.enriched$Freq / sum(all.3gram.95.freq.enriched$Freq)
#
all.3gram.95.freq.enriched$UNK_0.Freq.Cum.Pct <- cumsum(
  ifelse(all.3gram.95.freq.enriched$UNK_N == 0,
         all.3gram.95.freq.enriched$Freq.Pct,
         0))
all.3gram.95.freq.enriched$UNK_1.Freq.Cum.Pct <- cumsum(
  ifelse(all.3gram.95.freq.enriched$UNK_N == 1,
         all.3gram.95.freq.enriched$Freq.Pct,
         0))
all.3gram.95.freq.enriched$UNK_2.Freq.Cum.Pct <- cumsum(
  ifelse(all.3gram.95.freq.enriched$UNK_N == 2,
         all.3gram.95.freq.enriched$Freq.Pct,
         0))
all.3gram.95.freq.enriched$UNK_3.Freq.Cum.Pct <- cumsum(
  ifelse(all.3gram.95.freq.enriched$UNK_N == 3,
         all.3gram.95.freq.enriched$Freq.Pct,
         0))

# We want to use sample points. Over how many points we have to jump?
all.3gram.95.freq.idx <- unique(as.integer(exp((1:1000) * log(nrow(all.3gram.95.freq)) / 1000)))

all.3gram.95.freq.pct <- rbind(
  data.frame("Type" = rep("3 UNK", length(all.3gram.95.freq.idx)),
             "Count" = all.3gram.95.freq.idx,
             "Freq.Pct" = all.3gram.95.freq.enriched$UNK_3.Freq.Cum.Pct[all.3gram.95.freq.idx]),
  data.frame("Type" = rep("2 UNK", length(all.3gram.95.freq.idx)),
             "Count" = all.3gram.95.freq.idx,
             "Freq.Pct" = all.3gram.95.freq.enriched$UNK_2.Freq.Cum.Pct[all.3gram.95.freq.idx]),
  data.frame("Type" = rep("1 UNK", length(all.3gram.95.freq.idx)),
             "Count" = all.3gram.95.freq.idx,
             "Freq.Pct" = all.3gram.95.freq.enriched$UNK_1.Freq.Cum.Pct[all.3gram.95.freq.idx]),
  data.frame("Type" = rep("0 UNK", length(all.3gram.95.freq.idx)),
             "Count" = all.3gram.95.freq.idx,
             "Freq.Pct" = all.3gram.95.freq.enriched$UNK_0.Freq.Cum.Pct[all.3gram.95.freq.idx])
)
...
```{r cover4grams.95, echo=FALSE, cache=TRUE, cache.lazy=FALSE, fig.align='center', fig.width=10}
all.4gram.95.freq.enriched <- all.4gram.95.freq

# Enrich 4-grams: add columns indicating whether n-th word is an UNK token.
all.4gram.95.freq.enriched$UNK_1 <- grepl("UNK \\S+ \\S+ \\S+", all.4gram.95.freq.enriched$Terms)
all.4gram.95.freq.enriched$UNK_2 <- grepl("\\S+ UNK \\S+ \\S+", all.4gram.95.freq.enriched$Terms)
all.4gram.95.freq.enriched$UNK_3 <- grepl("\\S+ \\S+ UNK \\S+", all.4gram.95.freq.enriched$Terms)
all.4gram.95.freq.enriched$UNK_4 <- grepl("\\S+ \\S+ \\S+ UNK", all.4gram.95.freq.enriched$Terms)

# Enrich 4-grams: add a column with a count of UNK token.
all.4gram.95.freq.enriched$UNK_N <- all.4gram.95.freq.enriched$UNK_1 +
  all.4gram.95.freq.enriched$UNK_2 +
  all.4gram.95.freq.enriched$UNK_3 +
  all.4gram.95.freq.enriched$UNK_4

# Enrich 4-grams: add percentage
all.4gram.95.freq.enriched$Freq.Pct <- all.4gram.95.freq.enriched$Freq / sum(all.4gram.95.freq.enriched$Freq)
#
all.4gram.95.freq.enriched$UNK_0.Freq.Cum.Pct <- cumsum(
  ifelse(all.4gram.95.freq.enriched$UNK_N == 0,
         all.4gram.95.freq.enriched$Freq.Pct,
         0))
all.4gram.95.freq.enriched$UNK_1.Freq.Cum.Pct <- cumsum(
  ifelse(all.4gram.95.freq.enriched$UNK_N == 1,
         all.4gram.95.freq.enriched$Freq.Pct,
         0))
all.4gram.95.freq.enriched$UNK_2.Freq.Cum.Pct <- cumsum(
  ifelse(all.4gram.95.freq.enriched$UNK_N == 2,
         all.4gram.95.freq.enriched$Freq.Pct,
         0))
all.4gram.95.freq.enriched$UNK_3.Freq.Cum.Pct <- cumsum(
  ifelse(all.4gram.95.freq.enriched$UNK_N == 3,
         all.4gram.95.freq.enriched$Freq.Pct,
         0))
all.4gram.95.freq.enriched$UNK_4.Freq.Cum.Pct <- cumsum(
  ifelse(all.4gram.95.freq.enriched$UNK_N == 4,
         all.4gram.95.freq.enriched$Freq.Pct,
         0))

# We want to use sample points. Over how many points we have to jump?
all.4gram.95.freq.idx <- unique(as.integer(exp((1:1000) * log(nrow(all.4gram.95.freq)) / 1000)))

all.4gram.95.freq.pct <- rbind(
  data.frame("Type" = rep("4 UNK", length(all.4gram.95.freq.idx)),
             "Count" = all.4gram.95.freq.idx,
             "Freq.Pct" = all.4gram.95.freq.enriched$UNK_4.Freq.Cum.Pct[all.4gram.95.freq.idx]),
  data.frame("Type" = rep("3 UNK", length(all.4gram.95.freq.idx)),
             "Count" = all.4gram.95.freq.idx,
             "Freq.Pct" = all.4gram.95.freq.enriched$UNK_3.Freq.Cum.Pct[all.4gram.95.freq.idx]),
  data.frame("Type" = rep("2 UNK", length(all.4gram.95.freq.idx)),
             "Count" = all.4gram.95.freq.idx,
             "Freq.Pct" = all.4gram.95.freq.enriched$UNK_2.Freq.Cum.Pct[all.4gram.95.freq.idx]),
  data.frame("Type" = rep("1 UNK", length(all.4gram.95.freq.idx)),
             "Count" = all.4gram.95.freq.idx,
             "Freq.Pct" = all.4gram.95.freq.enriched$UNK_1.Freq.Cum.Pct[all.4gram.95.freq.idx]),
  data.frame("Type" = rep("0 UNK", length(all.4gram.95.freq.idx)),
             "Count" = all.4gram.95.freq.idx,
             "Freq.Pct" = all.4gram.95.freq.enriched$UNK_0.Freq.Cum.Pct[all.4gram.95.freq.idx])
)

# Clean up memory
rm(all.4gram.95.freq.enriched)
gc(full = TRUE)
...
```{r cover5grams.95, echo=FALSE, cache=TRUE, cache.lazy=FALSE, fig.align='center', fig.width=10}
all.5gram.95.freq.enriched <- all.5gram.95.freq

# Enrich 5-grams: add columns indicating whether n-th word is an UNK token.
all.5gram.95.freq.enriched$UNK_1 <- grepl("UNK \\S+ \\S+ \\S+ \\S+", all.5gram.95.freq.enriched$Terms)
all.5gram.95.freq.enriched$UNK_2 <- grepl("\\S+ UNK \\S+ \\S+ \\S+", all.5gram.95.freq.enriched$Terms)
all.5gram.95.freq.enriched$UNK_3 <- grepl("\\S+ \\S+ UNK \\S+ \\S+", all.5gram.95.freq.enriched$Terms)
all.5gram.95.freq.enriched$UNK_4 <- grepl("\\S+ \\S+ \\S+ UNK \\S+", all.5gram.95.freq.enriched$Terms)
all.5gram.95.freq.enriched$UNK_5 <- grepl("\\S+ \\S+ \\S+ \\S+ UNK", all.5gram.95.freq.enriched$Terms)

# Enrich 5-grams: add a column with a count of UNK token.
all.5gram.95.freq.enriched$UNK_N <- all.5gram.95.freq.enriched$UNK_1 +
  all.5gram.95.freq.enriched$UNK_2 +
  all.5gram.95.freq.enriched$UNK_3 +
  all.5gram.95.freq.enriched$UNK_4 +
  all.5gram.95.freq.enriched$UNK_5

# Enrich 5-grams: add percentage
all.5gram.95.freq.enriched$Freq.Pct <- all.5gram.95.freq.enriched$Freq / sum(all.5gram.95.freq.enriched$Freq)
#
all.5gram.95.freq.enriched$UNK_0.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 0,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))
all.5gram.95.freq.enriched$UNK_1.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 1,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))
all.5gram.95.freq.enriched$UNK_2.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 2,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))
all.5gram.95.freq.enriched$UNK_3.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 3,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))
all.5gram.95.freq.enriched$UNK_4.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 4,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))
all.5gram.95.freq.enriched$UNK_5.Freq.Cum.Pct <- cumsum(
  ifelse(all.5gram.95.freq.enriched$UNK_N == 5,
         all.5gram.95.freq.enriched$Freq.Pct,
         0))

# We want to use sample points. Over how many points we have to jump?
all.5gram.95.freq.idx <- unique(as.integer(exp((1:1000) * log(nrow(all.5gram.95.freq.enriched)) / 1000)))

all.5gram.95.freq.pct <- rbind(
  data.frame("Type" = rep("5 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_5.Freq.Cum.Pct[all.5gram.95.freq.idx]),
  data.frame("Type" = rep("4 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_4.Freq.Cum.Pct[all.5gram.95.freq.idx]),
  data.frame("Type" = rep("3 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_3.Freq.Cum.Pct[all.5gram.95.freq.idx]),
  data.frame("Type" = rep("2 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_2.Freq.Cum.Pct[all.5gram.95.freq.idx]),
  data.frame("Type" = rep("1 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_1.Freq.Cum.Pct[all.5gram.95.freq.idx]),
  data.frame("Type" = rep("0 UNK", length(all.5gram.95.freq.idx)),
             "Count" = all.5gram.95.freq.idx,
             "Freq.Pct" = all.5gram.95.freq.enriched$UNK_0.Freq.Cum.Pct[all.5gram.95.freq.idx])
)

# Clean up memory.
rm(all.5gram.95.freq.enriched)
gc(full = TRUE)
...
```{r cover6grams.95, echo=FALSE, cache=TRUE, cache.lazy=FALSE, fig.align='center', fig.width=10}
all.6gram.95.freq.enriched <- all.6gram.95.freq

# Enrich 6-grams: add columns indicating whether n-th word is an UNK token.
all.6gram.95.freq.enriched$UNK_1 <- grepl("UNK \\S+ \\S+ \\S+ \\S+ \\S+", all.6gram.95.freq.enriched$Terms)
all.6gram.95.freq.enriched$UNK_2 <- grepl("\\S+ UNK \\S+ \\S+ \\S+ \\S+", all.6gram.95.freq.enriched$Terms)
all.6gram.95.freq.enriched$UNK_3 <- grepl("\\S+ \\S+ UNK \\S+ \\S+ \\S+", all.6gram.95.freq.enriched$Terms)
all.6gram.95.freq.enriched$UNK_4 <- grepl("\\S+ \\S+ \\S+ UNK \\S+ \\S+", all.6gram.95.freq.enriched$Terms)
all.6gram.95.freq.enriched$UNK_5 <- grepl("\\S+ \\S+ \\S+ \\S+ UNK \\S+", all.6gram.95.freq.enriched$Terms)
all.6gram.95.freq.enriched$UNK_6 <- grepl("\\S+ \\S+ \\S+ \\S+ \\S+ UNK", all.6gram.95.freq.enriched$Terms)

# Enrich 6-grams: add a column with a count of UNK token.
all.6gram.95.freq.enriched$UNK_N <- all.6gram.95.freq.enriched$UNK_1 +
  all.6gram.95.freq.enriched$UNK_2 +
  all.6gram.95.freq.enriched$UNK_3 +
  all.6gram.95.freq.enriched$UNK_4 +
  all.6gram.95.freq.enriched$UNK_5 +
  all.6gram.95.freq.enriched$UNK_6

# Enrich 5-grams: add percentage
all.6gram.95.freq.enriched$Freq.Pct <- all.6gram.95.freq.enriched$Freq / sum(all.6gram.95.freq.enriched$Freq)
#
all.6gram.95.freq.enriched$UNK_0.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 0,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_1.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 1,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_2.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 2,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_3.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 3,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_4.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 4,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_5.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 5,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))
all.6gram.95.freq.enriched$UNK_6.Freq.Cum.Pct <- cumsum(
  ifelse(all.6gram.95.freq.enriched$UNK_N == 6,
         all.6gram.95.freq.enriched$Freq.Pct,
         0))

# We want to use sample points. Over how many points we have to jump?
all.6gram.95.freq.idx <- unique(as.integer(exp((1:1000) * log(nrow(all.6gram.95.freq.enriched)) / 1000)))

all.6gram.95.freq.pct <- rbind(
  data.frame("Type" = rep("6 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_6.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("5 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_5.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("4 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_4.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("3 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_3.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("2 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_2.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("1 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_1.Freq.Cum.Pct[all.6gram.95.freq.idx]),
  data.frame("Type" = rep("0 UNK", length(all.6gram.95.freq.idx)),
             "Count" = all.6gram.95.freq.idx,
             "Freq.Pct" = all.6gram.95.freq.enriched$UNK_0.Freq.Cum.Pct[all.6gram.95.freq.idx])
)

# Clean up memory.
rm(all.6gram.95.freq.enriched)
gc(full = TRUE)
